...
/* JADX INFO: loaded from: C:\Users\badinteger\Files\.mess\extera\dex_files\classes4.dex */
...
public final /* synthetic */ class NowPlayingController$ItunesSearchResponse$$serializer implements GeneratedSerializer<NowPlayingController.ItunesSearchResponse> {
    ...
    public final KSerializer<?>[] childSerializers() {
        return new KSerializer[]{IntSerializer.INSTANCE, (KSerializer<?>) NowPlayingController.ItunesSearchResponse.$childSerializers[1].getValue()};
    }
