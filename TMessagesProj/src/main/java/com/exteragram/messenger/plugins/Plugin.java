...
public final class Plugin {
    ...
    public final void setIcon(String link) {
        int iLastIndexOf;
        if (INSTANCE.isIconValid(link) && (iLastIndexOf = link.lastIndexOf('/')) != -1) {
            String strSubstring = link.substring(0, iLastIndexOf);
            this.pack = strSubstring;
            String strSubstring2 = link.substring(iLastIndexOf + 1);
