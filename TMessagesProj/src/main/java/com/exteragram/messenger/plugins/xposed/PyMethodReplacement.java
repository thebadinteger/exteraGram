...
public final class PyMethodReplacement extends XC_MethodReplacement implements AutoCloseable {
    ...
    public PyMethodReplacement(String str, PyObject pyObject) {
        ...
        if (!pyObject.containsKey("replace_hooked_method")) {
            RandomKt$$ExternalSyntheticBUOutline0.m("Python callback object must contain a method named 'replaceHookedMethod'");
            throw null;
        }
        this.pluginId = str;
        ...
        if (obj != null) {
            ...
            RandomKt$$ExternalSyntheticBUOutline0.m("Required value was null.");
            throw null;
        }
    }
