...
public final class PasskeysUtil {
    private static final String TYPE_GET = -42865790305839L);
    ...
    public static final String generateClientDataJSONRaw(boolean get, String challenge, String rpId) {
        String string = new JSONObject().put("type", Deobfuscator$exteraGramDev$TMessagesProj.getString(get ? "webauthn.get" : "webauthn.create").put("challenge", challenge).put("origin", rpId).toString();
        "toString(...)";
        return string;
    }
