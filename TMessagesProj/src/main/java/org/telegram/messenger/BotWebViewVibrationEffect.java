...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_RIGID(new long[]{3}, new int[]{Opcodes.SHR_INT_LIT8}, new long[]{50}),
    ...
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{Opcodes.SHR_INT_LIT8, 0, 175}, new long[]{65, 60, 40}),
    ...
    public VibrationEffect getVibrationEffectForOreo() {
        ...
        return BotWebViewVibrationEffect$$ExternalSyntheticApiModelOutline0.m(this.vibrationEffect);
    }
