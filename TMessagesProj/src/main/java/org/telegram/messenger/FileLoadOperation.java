...
//        FileLog.e("FileLoadOperation " + getFileName() + " setStream(" + stream + ")");
    ...
    private void updateParams() {
        if (com.exteragram.messenger.ExteraConfig.getDownloadSpeedBoost() == 2) {
            downloadChunkSizeBig = 1024 * 1024;
            maxDownloadRequests = 12;
            maxDownloadRequestsBig = 12;
        } else if ((preloadPrefixSize > 0 || com.exteragram.messenger.ExteraConfig.getDownloadSpeedBoost() == 1 || MessagesController.getInstance(currentAccount).getfileExperimentalParams) && !forceSmallChunk) {
