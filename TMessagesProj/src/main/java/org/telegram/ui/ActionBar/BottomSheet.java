...
public class BottomSheet extends Dialog implements BaseFragment.AttachedSheet {
    ...
    public class ContainerView extends FrameLayout {
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canSwipeToBack(motionEvent) || this.allowedSwipeToBack) {
                ...
                boolean zIsTouchOutside = BottomSheet.this.isTouchOutside(this.startedTrackingX, y2);
                BottomSheet bottomSheet = BottomSheet.this;
                if (zIsTouchOutside) {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (rect.bottom != 0 && rect.top != 0) {
                ...
                int i4 = BottomSheet.this.keyboardHeight;
                ...
                BottomSheet.this.bottomInset -= BottomSheet.this.keyboardHeight;
            } else {
                bottomSheet.keyboardHeight = 0;
            }
            BottomSheet bottomSheet4 = BottomSheet.this;
            int i5 = bottomSheet4.keyboardHeight;
            if (i3 != i5) {
                this.keyboardChanged = true;
            }
            boolean z = bottomSheet4.keyboardVisible;
            bottomSheet4.keyboardVisible = i5 > AndroidUtilities.dp(20.0f);
            BottomSheet bottomSheet5 = BottomSheet.this;
            if (z != bottomSheet5.keyboardVisible && Build.VERSION.SDK_INT >= 34) {
                bottomSheet5.updateBackCallbackState();
            }
            if (BottomSheet.this.lastInsets != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    BottomSheet.this.bottomInset += BottomSheet.this.getAdditionalMandatoryOffsets();
                }
                BottomSheet bottomSheet9 = BottomSheet.this;
                if (bottomSheet9.keyboardVisible) {
                    Rect rect3 = this.rect;
                    if (rect3.bottom != 0 && rect3.top != 0) {
                        bottomSheet9.bottomInset -= BottomSheet.this.keyboardHeight;
                    }
                }
                BottomSheet bottomSheet10 = BottomSheet.this;
                if (bottomSheet10.drawNavigationBar || bottomSheet10.occupyNavigationBar || bottomSheet10.occupyNavigationBarWithoutKeyboard) {
                    bottomInset = size2;
                } else {
                    bottomInset = size2 - bottomSheet10.getBottomInset();
                }
            } else {
                bottomInset = size2;
            }
            ...
            bottomSheet11.navigationBarHeight = 0;
            if (bottomSheet11.lastInsets != null) {
                BottomSheet bottomSheet12 = BottomSheet.this;
                if (!bottomSheet12.occupyNavigationBar) {
                    int systemWindowInsetBottom = (int) (bottomSheet12.lastInsets.getSystemWindowInsetBottom() * (1.0f - BottomSheet.this.hideSystemVerticalInsetsProgress));
                    if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (viewGroup != null) {
                if (!bottomSheet13.fullWidth) {
                    if (AndroidUtilities.isTablet()) {
                        ...
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(((int) Math.min(fDp, Math.min(point.x, point.y) * 0.8f)) + (BottomSheet.this.backgroundPaddingLeft * 2), TLObject.FLAG_30);
                    } else {
                        BottomSheet bottomSheet14 = BottomSheet.this;
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(bottomSheet14.getBottomSheetWidth(bottomSheet14.isPortrait, i7, i6) + (BottomSheet.this.backgroundPaddingLeft * 2), TLObject.FLAG_30);
                    }
                    BottomSheet.this.containerView.measure(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(i6, Integer.MIN_VALUE));
                } else {
                    viewGroup.measure(View.MeasureSpec.makeMeasureSpec((bottomSheet13.backgroundPaddingLeft * 2) + i7, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i6, Integer.MIN_VALUE));
                }
            }
                    ...
                    if (!z2 ? viewGroup3.getTop() == measuredHeight : viewGroup3.getBottom() == BottomSheet.this.containerView.getMeasuredHeight() + measuredHeight) {
                        ...
                        BottomSheet.this.keyboardContentAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ActionBar.BottomSheet$ContainerView$$ExternalSyntheticLambda0
                            ...
                            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                this.f$0.lambda$onLayout$4(valueAnimator2);
                            }
                        });
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            if (i >= 26) {
                ...
                if (i2 >= 0) {
                    paint.setColor(bottomSheet2.getThemedColor(i2));
                } else {
                    paint.setColor(bottomSheet2.navBarColor);
                }
            } else {
            ...
            if (BottomSheet.this.containerView.getY() + BottomSheet.this.containerView.getMeasuredHeight() < getMeasuredHeight()) {
                ...
                paint2.setColor(i3 >= 0 ? bottomSheet12.getThemedColor(i3) : bottomSheet12.behindKeyboardColor);
                int left = BottomSheet.this.containerView.getLeft();
                BottomSheet bottomSheet13 = BottomSheet.this;
                canvas.drawRect(left + bottomSheet13.backgroundPaddingLeft, bottomSheet13.containerView.getY() + BottomSheet.this.containerView.getMeasuredHeight(), BottomSheet.this.containerView.getRight() - BottomSheet.this.backgroundPaddingLeft, getMeasuredHeight(), this.backgroundPaint);
            }
        }
        ...
        public void drawNavigationBar(Canvas canvas, float f) {
            ...
            if (!BottomSheet.this.transitionFromRight || BottomSheet.this.containerView.getVisibility() == 0) {
                ...
                boolean z = BottomSheet.this.transitionFromRight;
                BottomSheet bottomSheet6 = BottomSheet.this;
                int x = z ? (int) bottomSheet6.containerView.getX() : bottomSheet6.containerView.getLeft();
                if (alpha2 < 1.0f) {
    ...
    public BottomSheet(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.openDuration = MediaError.DetailedErrorCode.MANIFEST_UNKNOWN;
        ...
        ContainerView containerView = new ContainerView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.1
            ...
            public void onAttachedToWindow() {
                ...
                Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.ActionBar.BottomSheet.1.1
        ...
        if (i2 >= 30) {
            containerView2.setSystemUiVisibility(1792);
        } else {
            containerView2.setSystemUiVisibility(1280);
        }
    ...
    private void onCreateInternal() {
        ...
        if (this.title != null) {
            TextView textView = new TextView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.3
                @Override // android.widget.TextView, android.view.View
                public void onMeasure(int i2, int i3) {
                    super.onMeasure(i2, i3);
                    if (BottomSheet.this.multipleLinesTitle) {
                        int measuredHeight = getMeasuredHeight();
                        View view = BottomSheet.this.customView;
                        BottomSheet bottomSheet = BottomSheet.this;
                        if (view != null) {
            ...
            if (z) {
                ...
                textView2.setTextColor(getThemedColor(Theme.key_dialogTextGray2));
            ...
            boolean z2 = this.multipleLinesTitle;
            ...
            this.containerView.addView(this.titleView, LayoutHelper.createFrame(-1, this.multipleLinesTitle ? -2.0f : 48.0f));
        ...
        if (view != null) {
            ...
            boolean z3 = this.useBackgroundTopPadding;
            ...
            if (!z3) {
                ...
                viewGroup.addView(this.customView, LayoutHelper.createFrame(-1, -2.0f, this.customViewGravity, 0.0f, i, 0.0f, 0.0f));
            }
    ...
    public void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            if (z) {
                sheetBackDrawable.setAlpha(this.dimBehind ? this.dimBehindAlpha : 0);
                this.containerView.setTranslationY(0.0f);
                onContainerViewTranslation();
                return;
            }
            sheetBackDrawable.setAlpha(0);
            this.layoutCount = 2;
            ViewGroup viewGroup = this.containerView;
            ...
            Runnable runnable = new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet.4
                @Override // java.lang.Runnable
                public void run() {
                    BottomSheet bottomSheet = BottomSheet.this;
    ...
    public void startOpenAnimation() {
        ...
        boolean z = this.transitionFromRight;
        ViewGroup viewGroup = this.containerView;
        if (z) {
            viewGroup.setTranslationX(AndroidUtilities.dp(48.0f));
            this.containerView.setAlpha(0.0f);
            this.containerView.setTranslationY(0.0f);
        } else {
            viewGroup.setTranslationY(getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.dp(10.0f) + Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())));
        }
        onContainerViewTranslation();
        ...
        boolean z2 = this.transitionFromRight;
        AnimatorSet animatorSet = this.currentSheetAnimation;
        if (z2) {
            animatorSet.setDuration(250L);
            this.currentSheetAnimation.setInterpolator(CubicBezierInterpolator.DEFAULT);
        } else {
            animatorSet.setDuration(this.openDuration);
            this.currentSheetAnimation.setInterpolator(this.openInterpolator);
        }
        this.currentSheetAnimation.setStartDelay(this.waitingKeyboard ? 0L : 20L);
        this.currentSheetAnimation.setInterpolator(this.openInterpolator);
        this.notificationsLocker.lock();
        this.currentSheetAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.BottomSheet.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    public class AnonymousClass6 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (animatorSet != null && animatorSet.equals(animator)) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet$6$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    @Override // org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
    public View mo6342getWindowView() {
        return this.container;
    }
            ...
            if (this.skipDismissAnimation) {
                ...
                if (!this.allowCustomAnimation || !onCustomCloseAnimation()) {
                    ...
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda10
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            this.f$0.lambda$dismiss$11(valueAnimator2);
                        }
                    });
                    this.currentSheetAnimation = new AnimatorSet();
                    ArrayList<Animator> arrayList = new ArrayList<>();
                    ...
                    if (viewGroup != null) {
                        if (this.transitionFromRight) {
                            ...
                            objectAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda11
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                    this.f$0.lambda$dismiss$12(valueAnimator2);
                                }
                            });
                            arrayList.add(objectAnimatorOfFloat);
                            ...
                            objectAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ActionBar.BottomSheet$$ExternalSyntheticLambda12
                                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                                    this.f$0.lambda$dismiss$13(valueAnimator2);
                                }
                            });
    ...
    public void setOverlayNavBarColor(int i) {
        ...
        if (this.attachedFragment != null) {
            LaunchActivity.instance.checkSystemBarColors(true, true, true);
            AndroidUtilities.setLightNavigationBar(mo6342getWindowView(), AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(getThemedColor(Theme.key_windowBackgroundGray))) >= 0.721f);
        } else {
    ...
    public void updateBackCallbackState() {
        ...
        if (z && this.isBackCallbackRegistered) {
            ...
            onBackInvokedDispatcher.registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, onBackAnimationCallback);
            this.isBackCallbackRegistered = true;
        }
    }

    public void registerBackCallback() {
        if (this.backAnimationCallback != null || ExteraConfig.getPredictiveBackIntensity() == 0.0f) {
            return;
        }
        ContainerView containerView = this.container;
        ...
        OnBackAnimationCallback onBackAnimationCallback = new OnBackAnimationCallback() { // from class: org.telegram.ui.ActionBar.BottomSheet.8
            ...
            public void onBackProgressed(BackEvent backEvent) {
                ...
                BottomSheet bottomSheet = BottomSheet.this;
                SheetBackDrawable sheetBackDrawable = bottomSheet.backDrawable;
                if (sheetBackDrawable != null) {
                    sheetBackDrawable.setAlpha((int) (bottomSheet.dimBehindAlpha * (1.0f - progress)));
                }
            }
            ...
            public void onBackCancelled() {
                ...
                if (bottomSheet.backDrawable != null) {
                    ...
                    BottomSheet bottomSheet2 = BottomSheet.this;
                    animatorSet.playTogether(ObjectAnimator.ofInt(bottomSheet2.backDrawable, (Property<SheetBackDrawable, Integer>) AnimationProperties.COLOR_DRAWABLE_ALPHA, bottomSheet2.dimBehind ? bottomSheet2.dimBehindAlpha : 0));
                }
                ...
                BottomSheet.this.container.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.BottomSheet.8.1
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
        ...
        this.backAnimationCallback = onBackAnimationCallback;
        if (this.keyboardVisible) {
            return;
        }
        this.onBackInvokedDispatcher.registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, onBackAnimationCallback);
        this.isBackCallbackRegistered = true;
    }
