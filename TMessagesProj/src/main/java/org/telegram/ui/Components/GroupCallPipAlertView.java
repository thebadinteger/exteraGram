...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Code duplicated, block: B:19:0x003b A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:20:0x003d  */
    /* JADX WARN: Code duplicated, block: B:22:0x0043  */
    /* JADX WARN: Code duplicated, block: B:24:0x004a  */
    /* JADX WARN: Code duplicated, block: B:34:0x006a A[DONT_INVERT] */
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i2 == 0) {
            ...
            float f9 = this.cx;
            if (i2 == 2) {
                translationX = f9 - getTranslationX();
                measuredHeight = 0.0f;
            } else {
                translationX = f9 - getTranslationX();
    ...
    private void updateButtons(boolean z) {
        ...
        boolean zMutedByAdmin = sharedInstance.mutedByAdmin();
        VoIPToggleButton voIPToggleButton2 = this.muteButton;
        if (zMutedByAdmin) {
            voIPToggleButton2.setData(R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, 76), 0.1f, true, LocaleController.getString(R.string.VoipMutedByAdminShort), true, z);
        } else {
            voIPToggleButton2.setData(R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, (int) ((sharedInstance.isMicMute() ? 0.3f : 0.15f) * 255.0f)), 0.1f, true, LocaleController.getString(sharedInstance.isMicMute() ? R.string.VoipUnmute : R.string.VoipMute), sharedInstance.isMicMute(), z);
        }
        invalidate();
    }
