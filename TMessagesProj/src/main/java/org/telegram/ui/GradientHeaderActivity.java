...
public abstract class GradientHeaderActivity extends BaseFragment {
    ...
    public View getHeader(Context context) {
        View view = new View(context) { // from class: org.telegram.ui.GradientHeaderActivity.3
            ...
            public void onMeasure(int i, int i2) {
                ...
                gradientHeaderActivity3.firstViewHeight = (int) (gradientHeaderActivity3.firstViewHeight - (GradientHeaderActivity.this.yOffset * 2.5f));
    ...
    public View createView(Context context) {
        ...
        boolean z = adapterCreateAdapter instanceof UniversalAdapter;
        RecyclerListView recyclerListView = this.listView;
        if (z) {
            Utilities.CallbackReturn<View, Boolean> callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.GradientHeaderActivity$$ExternalSyntheticLambda1
                @Override 
            ...
            float fDp = AndroidUtilities.dp(ExteraConfig.getSectionRadiusDp());
        ...
        this.listView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GradientHeaderActivity.4
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    ...
                    float f = GradientHeaderActivity.this.totalProgress;
                    GradientHeaderActivity gradientHeaderActivity = GradientHeaderActivity.this;
                    if (f > 0.5f) {
                        gradientHeaderActivity.listView.smoothScrollBy(0, gradientHeaderActivity.currentYOffset - bottom);
                        return;
                    }
                    View viewFindViewByPosition = gradientHeaderActivity.listView.getLayoutManager() != null ? GradientHeaderActivity.this.listView.getLayoutManager().findViewByPosition(0) : null;
    ...
    public class ContentView extends NestedSizeNotifierLayout {
        ...
        @Override // org.telegram.ui.Components.NestedSizeNotifierLayout, org.telegram.ui.Components.SizeNotifierFrameLayout, org.telegram.ui.ActionBar.Theme.Colorable
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            if (!gradientHeaderActivity.isDialogVisible) {
                boolean z = GradientHeaderActivity.this.inc;
                GradientHeaderActivity gradientHeaderActivity2 = GradientHeaderActivity.this;
                if (z) {
                    gradientHeaderActivity2.progress += 0.016f;
            ...
            int bottom = ((BaseFragment) GradientHeaderActivity.this).actionBar.getBottom() + AndroidUtilities.dp(16.0f);
            GradientHeaderActivity gradientHeaderActivity3 = GradientHeaderActivity.this;
            gradientHeaderActivity3.totalProgress = 1.0f - ((gradientHeaderActivity3.currentYOffset - bottom) / (GradientHeaderActivity.this.firstViewHeight - bottom));
            GradientHeaderActivity gradientHeaderActivity4 = GradientHeaderActivity.this;
            gradientHeaderActivity4.totalProgress = Utilities.clamp(gradientHeaderActivity4.totalProgress, 1.0f, 0.0f);
            ...
            if (gradientHeaderActivity5.isLandscapeMode) {
                gradientHeaderActivity5.progressToFull = 1.0f;
            ...
            gradientHeaderActivity6.particlesView.setAlpha(1.0f - gradientHeaderActivity6.totalProgress);
            ...
            if (gradientHeaderActivity7.whiteBackground) {
                this.backgroundGradientPaint.setColor(gradientHeaderActivity7.getThemedColor(Theme.key_windowBackgroundGray));
            ...
            GradientHeaderActivity gradientHeaderActivity8 = GradientHeaderActivity.this;
            int iBlendARGB = ColorUtils.blendARGB(themedColor, gradientHeaderActivity8.getThemedColor(gradientHeaderActivity8.whiteBackground ? Theme.key_windowBackgroundWhiteBlackText : Theme.key_premiumGradientBackgroundOverlay), f3);
    ...
    public static class BackgroundView extends LinearLayout {
        ...
        public void setData(CharSequence charSequence, CharSequence charSequence2, View view, View view2) {
            ...
            FrameLayout frameLayout = this.aboveTitleLayout;
            if (view != null) {
            ...
            FrameLayout frameLayout2 = this.belowSubTitleLayout;
            if (view2 != null) {
