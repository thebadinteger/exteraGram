...
public class LinkManager {
    ...
    public LinkManager(LaunchActivity activity, int account, Browser.Progress progress, boolean isExternalIntent) {
        this.activity = activity;
        this.currentAccount = account;
        this.progress = progress;
        this.isExternalIntent = isExternalIntent;
    }
            ...
            if ("share".equalsIgnoreCase(second)) {
                ...
                presentFragment(new QrActivity(args) {
                    ...
                    public void onBecomeFullyVisible() {
                        ...
                        AndroidUtilities.runOnUIThread(this::performShare);
                    }
                });
                return true;
            }
